...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <div class="col s12">
         <ul class="collapsible collapsible-accordion">
            <li class="">
               <div class="collapsible-header" tabindex="0"><i class="material-icons">blur_circular</i> First Header</div>
            ...
            <li class="">
               <div class="collapsible-header" tabindex="0"><i class="material-icons">details</i> Preselected Section</div>
               <div class="collapsible-body" ">
                  <p>
                     Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                     et
            ...
            <li class="">
               <div class="collapsible-header" tabindex="0"><i class="material-icons">filter_center_focus</i> Third Header</div>
               <div class="collapsible-body" >
                  <p>
                     Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                     et
