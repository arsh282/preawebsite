      ...
      if(isset($_POST['brand_name']) && isset($_POST['upc']) && isset($_POST['part_code']) && isset($_POST['description']) && isset($_POST['hsn'])){
        ...
        // print_r($_POST);
          for($i = 0; $i < count($brand_name) ; $i ++){
            ...
            // echo  $insert="INSERT INTO add_product(upc,part_code,description,hsn,brand_name) VALUES(`$v1`,`$v2`,`$v3`,`$v4`,`$v5`)";
            $insert= "INSERT INTO `products` ( `upc`, `part_code`, `description`, `hsn`, `brand_name`) VALUES ('$v1 ', '$v2', '$v3', '$v4', '$v5') ";
