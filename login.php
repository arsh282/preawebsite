                  ...
                  <form class="login-form" method="post" >
                    ...
                    <div class="row margin">
                      <div class="input-field col s12">
                        ...
                        <input id="username" id="username" type="text" name="username" value="<?php if(isset($_COOKIE["username"])) { echo $_COOKIE["username"]; } ?>">
                    ...
                    <div class="row margin">
                      <div class="input-field col s12">
                        ...
                        <input id="password" type="password" name="password" id="password" value="<?php if(isset($_COOKIE["password"])) { echo $_COOKIE["password"]; } ?>">
                        <label for="password">Password</label>
                      </div>
                    </div>
                     <div class="row margin">
                        <div style="margin-top: 7px;color:green;" id="CheckPasswordMatch"></div>
                    </div>
                    <div class="row">
