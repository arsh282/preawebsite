...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/preawebsite/app-assets/css/pages/form-select2.min.css">
    <link rel="stylesheet" href="/preawebsite/vendors/select2/select2.min.css" type="text/css">
    <link rel="stylesheet" href="/preawebsite/vendors/select2/select2-materialize.css" type="text/css">
  ...
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
    ...
    <script src="/preawebsite/vendors/select2/select2.full.min.js"></script>
    <script src="/preawebsite/app-assets/js/scripts/form-select2.min.js"></script>
