 ...
 <!-- BEGIN: SideNav-->
    <div class="row">
      ...
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        ...
        <li class="bold">
          <a class="waves-effect waves-cyan " href="<?=base_url;?>add_brand.php">
            <i class="material-icons">mail_outline</i>
            <span class="menu-title" data-i18n="Mail">Add Brands</span>
          </a>
        </li>   
        <li class="bold">
          <a class="waves-effect waves-cyan " href="<?=base_url;?>add_product.php">
            <i class="material-icons">mail_outline</i>
            <span class="menu-title" data-i18n="Mail">Add Products</span>
          </a>
        </li>
        <li class="bold">
          <a class="waves-effect waves-cyan " href="<?=base_url;?>supplier.php">
            <i class="material-icons">mail_outline</i>
